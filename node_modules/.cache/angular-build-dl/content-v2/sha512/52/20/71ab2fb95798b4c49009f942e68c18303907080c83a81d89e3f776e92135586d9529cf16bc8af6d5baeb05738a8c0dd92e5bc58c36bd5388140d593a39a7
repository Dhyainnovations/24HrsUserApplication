(function () {
  ...
  (self["webpackChunkseller_app"] = self["webpackChunkseller_app"] || []).push([["src_app_tab1_tab1_module_ts"], {
      ...
      var _Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(router, activatedRoute, http, route, popoverController) {
          ...
          route.params.subscribe(function (val) {
            _this29.getSelectCategory();

            _this29.offerList();

            _this29.locationList();

            _this29.expiryOfferList();
        ...
        _createClass(Tab1Page, [{
          ...
          value: function UserDetails() {
            ...
            this.http.get('/user_details').subscribe(function (response) {
              console.log(response);
              _this31.loginUserTbid = response.records.user_name;
              _this31.loginUserName = response.records.user_name;
              _this31.loginUserNumber = response.records.user_name;
              _this31.loginUserLocation = response.records.user_name;
              _this31.loginUserToken = response.records.user_name;
            }, function (error) {
              console.log(error);
            });
          }
          ...
          value: function singleCard(product) {
            ...
            this.http.get('/readone_offer_user?o=' + o).subscribe(function (response) {
              if (response.success == "true") {
                _this33.storeTbid = response.records.tbid;
                _this33.storeLogo = response.records.store_logo;
                _this33.storeName = response.records.store_name;
                _this33.productName = response.records.product;
                _this33.productImage = response.records.product_image;
                _this33.description = response.records.description;
                _this33.offer = response.records.offer;
                _this33.totalPrice = response.records.total_cost;
                _this33.offerPrice = response.records.offer_price;
                _this33.offerTime = response.records.offer_time, _this33.unit = response.records.product_unit;
              }
            }, function (error) {
              console.log(error);
            });
          ...
          value: function storeDetails(storename) {
            ...
            this.http.post('/store_details_user', obj).subscribe(function (response) {
              _this34.storedetails = response.records;
              console.log(_this34.storedetails);
              _this34.storeAddress = response.records.address_line_1 + " " + response.records.address_line_2 + " " + response.records.city + " : " + response.records.pincode + " " + response.records.state;
              _this34.websiteLink = response.records.website;
              _this34.whatsApp = response.records.whatsapp;
              _this34.contact = response.records.contact_number;
              _this34.instagram = response.records.instagram;
              _this34.storeID = response.records.tbid;
              _this34.storeLogo = response.records.store_logo;
              _this34.deliveryAvilability = response.records.delivery_availability;

              if (_this34.deliveryAvilability == 1 && _this34.deliveryAvilability == false && _this34.deliveryAvilability == "Available") {
                _this34.deliveryAvilability = false;
              } else {
                _this34.deliveryAvilability = true;
              }
            }, function (error) {
              console.log(error);
            });
          ...
          value: function getSelectCategory() {
            ...
            this.http.get('/store_category_user').subscribe(function (response) {
              _this35.getCategoryList = response.records;
              console.log(response);
            }, function (error) {
              console.log(error);
            });
          ...
          value: function offerList() {
            ...
            this.http.post('/list_all_offer', data).subscribe(function (response) {
              _this36.offerlist = response.records;
              console.log(_this36.offerlist);

              if (response.message == "No offers found.") {
                _this36.noDataFound = true;
              } else {
                _this36.noDataFound = false;
              }
            }, function (error) {
              console.log(error);
              _this36.noDataFound = true;
          ...
          value: function expiryOfferList() {
            ...
            this.http.get('/list_offer_expiry').subscribe(function (response) {
              _this37.ExpirynoDataFound = false;
              _this37.expiryofferlist = response.records;
              console.log(_this37.expiryofferlist); // if(response.message == "No offers found."){
          ...
          value: function clickSlide(item) {
            ...
            this.http.post('/list_offer_category', obj).subscribe(function (response) {
              if (response.success == "true") {
                _this38.offerlist = response.records;
                console.log(response);
                _this38.offerListVisible = true;
                _this38.noDataFound = false;
              } else {}
            }, function (error) {
              console.log(error);
              _this38.offerListVisible = false;
              _this38.noDataFound = true;
            });
          }
        }, {
          key: "locationList",
          value: function locationList() {
            ...
            this.http.get('/list_location').subscribe(function (response) {
              console.log(response);
              _this39.locationsList = response.records;
          ...
          value: function changeLocation() {
            ...
            if (this.city == "All") {
              this.http.get('/list_all_offer').subscribe(function (response) {
                _this40.offerlist = response.records;
                console.log(_this40.offerlist);

                if (response.message == "No offers found.") {
                  _this40.noDataFound = true;
                } else {
                  _this40.noDataFound = false;
                }
              }, function (error) {
                console.log(error);
                _this40.noDataFound = true;
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".card {\n  border: 1px solid #FFFFFF;\n  border-radius: 3px;\n  box-shadow: 4px 4px 4px 4px #ccc;\n  margin-bottom: 20px;\n  margin-right: 4px;\n  cursor: pointer;\n}\n\n#social-media-icon-div {\n  border: 1px solid #FFFFFF;\n  border-radius: 8px;\n  box-shadow: 4px 4px 4px 4px #ccc;\n}\n\np {\n  padding: 0 !important;\n  margin: 0 !important;\n}\n\n#offer {\n  padding: 2px !important;\n  margin: 5px !important;\n}\n\n.report-seller-btn {\n  border-radius: 5px !important;\n  text-align: center !important;\n  background: linear-gradient(to left, #f34f78 0%, #EB154B 100%);\n  color: #fff;\n  margin-left: 10%;\n}\n\n#product_img {\n  border: 1px solid #FFFFFF;\n  border-radius: 15%;\n  box-shadow: 3px 3px 16px 4px #ccc;\n  width: 85px;\n  height: 75px;\n}\n\n#expiryproduct_img {\n  border-radius: 15%;\n  opacity: 0.5;\n  box-shadow: 2px 2px 2px 2px #ccc;\n  width: 85px;\n  height: 75px;\n}\n\n#share {\n  color: #fff !important;\n}\n\n.dot {\n  height: 30px;\n  width: 30px;\n  margin-left: 5%;\n  background: #eb154b;\n  color: #fff;\n  border-radius: 50%;\n  display: inline-block;\n  box-shadow: 3px 3px 16px 4px #ccc;\n}\n\n#heart {\n  margin-left: -10px !important;\n  border-radius: 50% !important;\n  height: 20px;\n  width: 20px;\n}\n\n.green {\n  color: #404040 !important;\n}\n\n.red {\n  color: red !important;\n  border-radius: 55%;\n  padding: 2px;\n}\n\n.btn-default {\n  color: white;\n  background-color: blue;\n}\n\n.btn-change {\n  color: Red;\n  background-color: white;\n}\n\nion-chip.active {\n  color: red !important;\n  background: linear-gradient(to right, #555c59 0%, #1d1f1e 100%);\n}\n\nion-slides {\n  height: 50px !important;\n  padding-left: 15px;\n  padding-right: 15px;\n  margin-bottom: 15px;\n  background-color: #fff !important;\n}\n\n.featured-slide {\n  width: 50% !important;\n  border-radius: 10px;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n.featured-slide .info {\n  margin: 50px !important;\n  margin-left: 0 !important;\n  margin-right: 0px !important;\n  font-size: 17px !important;\n  color: #6E7989;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-start;\n}\n\n.div-slides {\n  bottom: 0;\n  width: 100%;\n  display: block;\n  background-color: #e6e6e6;\n}\n\n.div-slides img {\n  margin: 10px;\n  margin-right: 2px !important;\n  border-radius: 75px;\n}\n\n.tam-title {\n  margin-top: -0.5%;\n  font-size: 80%;\n  font-weight: bold;\n  color: #6E7989;\n}\n\nion-slide {\n  margin-left: -20px !important;\n  margin-right: 23px !important;\n  border-radius: 50%;\n}\n\nion-badge {\n  z-index: 999 !important;\n}\n\n#slideItem.active {\n  color: #121212;\n  font-weight: 700;\n}\n\n.tam-title.active {\n  color: blue !important;\n  background: linear-gradient(to right, #555c59 0%, #1d1f1e 100%);\n}\n\n.pop-up-card {\n  box-shadow: 2px 2px 3px rgba(128, 128, 128, 0.664);\n  position: absolute;\n  top: 35%;\n  z-index: 1;\n  left: 2%;\n  border-radius: 10px;\n  width: 95%;\n}\n\nion-label {\n  font-size: 10px !important;\n}\n\nion-checkbox {\n  margin: 10px;\n}\n\ninput {\n  border-radius: 3px;\n  width: 90%;\n}\n\n.submit-btn {\n  border-radius: 5px !important;\n  text-align: center !important;\n  background: linear-gradient(to left, #f34f78 0%, #EB154B 100%);\n  margin: 5px;\n  color: #fff;\n}\n\nion-item {\n  --background:#fffff;\n  height: 35px;\n  width: 100%;\n  margin-left: 35%;\n  --box-shadow: rgba(172, 22, 22, 0.04) 0px 3px 5px !important;\n}\n\n#expiryproductCard {\n  border: 1px solid #fff;\n  margin-left: 8px !important;\n  margin-right: 6px !important;\n  margin: 6px;\n  width: 45%;\n  background-color: #c7c7c7 !important;\n  border-radius: 2px;\n}\n\nion-content {\n  --background:#F4F7FA !important;\n  --offset-bottom: auto!important;\n  --overflow: hidden;\n  overflow: auto;\n}\n\nion-content::-webkit-scrollbar {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
