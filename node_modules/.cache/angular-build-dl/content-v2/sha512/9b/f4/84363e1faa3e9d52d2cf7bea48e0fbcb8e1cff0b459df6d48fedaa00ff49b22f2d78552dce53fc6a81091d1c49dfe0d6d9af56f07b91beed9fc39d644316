(function () {
  ...
  (self["webpackChunkseller_app"] = self["webpackChunkseller_app"] || []).push([["src_app_tab3_tab3_module_ts"], {
        ...
        _createClass(Tab3Page, [{
          ...
          value: function UserDetails() {
            ...
            this.http.get('/user_details').subscribe(function (response) {
              ...
              _this2.loginUserTbid = response.records.user_name;
              _this2.loginUserName = response.records.user_name;
              _this2.loginUserNumber = response.records.user_name;
              _this2.loginUserLocation = response.records.user_name;
              _this2.loginUserToken = response.records.user_name;
            }, function (error) {
              console.log(error);
            });
          ...
          value: function updateProfile() {
            ...
            this.http.post('/user_update_profile', updateData).subscribe(function (response) {
              ...
              if (response.success == "true") {
                _this3.updateUsername = response.user_name;
                _this3.PopupModel = false;
              } else {}
            }, function (error) {
              console.log(error);
            });
          ...
          value: function showPrompt() {
            ...
            this.alertController.create({
              ...
              buttons: [{
                ...
                text: 'Delete Account!',
                handler: function handler(data) {
                  _this5.password = data;
                  var obj = {
                    tbid: _this5.userdetails.id,
                    password: _this5.password
                  };
                  console.log(obj);

                  _this5.http.post('/user_delete_account', obj).subscribe(function (response) {
                    console.log(response);
          ...
          value: function locationList() {
            ...
            this.http.get('/list_location').subscribe(function (response) {
              console.log(response);
              _this7.locationsList = response.records;
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "* {\n  font-family: \"Roboto\", sans-serif;\n}\n\n.top-container {\n  background: linear-gradient(to left, #23a6d5 0%, #23d5ab 100%);\n  height: 28%;\n  border-bottom-left-radius: 25%;\n  border-bottom-right-radius: 25%;\n}\n\n.name {\n  font-size: 16px;\n  color: #5C5C5C;\n  text-align: left;\n  font-style: bold;\n  font-weight: 550;\n}\n\n.edit-name {\n  font-size: 15px;\n  margin-top: 5px;\n}\n\n.profile {\n  width: 160px;\n  height: 125px;\n  position: relative;\n  margin-top: 15%;\n  border: 2px solid #ffffff;\n  border-radius: 30px;\n  z-index: 999;\n}\n\n.editprofile {\n  width: 155px;\n  height: 150px;\n  border-radius: 5%;\n  margin-bottom: 5px !important;\n}\n\n.card {\n  box-shadow: 2px 2px 2px 2px #ccc;\n  border-radius: 10px;\n  margin: 5px;\n  width: 80%;\n  text-align: left;\n}\n\n.col-6 {\n  margin-bottom: 7px !important;\n}\n\nspan {\n  margin: 15px !important;\n  font-size: 14px !important;\n}\n\nsvg {\n  margin-left: 5px !important;\n}\n\n.myproduct-div {\n  align-items: center !important;\n  justify-content: center !important;\n  text-align: center !important;\n  background-color: #fff;\n  border: 1px solid #ebe6e6;\n  border-radius: 8px;\n  margin-left: 2% !important;\n  margin-right: 5% !important;\n  box-shadow: 2px 2px 2px 2px #ebe6e6;\n  width: 95% !important;\n  border-top-left-radius: 25%;\n  border-top-right-radius: 25%;\n}\n\nion-item {\n  --border-color: #fff;\n  text-align: left;\n  margin: 5px;\n}\n\ninput[type=text] {\n  font-size: 13px;\n  margin-top: 8px;\n  margin-left: -25px;\n  width: 100%;\n  box-sizing: border-box;\n  border: none;\n  background-color: #fff;\n  border-bottom: 2px solid #EB154B;\n}\n\ninput:focus {\n  outline: none !important;\n  border: 2px solid #EB154B !important;\n  box-shadow: 0 0 2px #e9f3ff;\n}\n\n#card {\n  position: absolute;\n  height: 150%;\n  width: 1500px !important;\n  margin-left: -10px;\n  background-color: rgba(0, 0, 0, 0.4);\n  border: 1px solid #ebe6e6;\n  border-radius: 5px;\n  box-shadow: 2px 2px 2px 2px #ccc;\n  margin-top: -215px !important;\n  z-index: 999;\n}\n\n#modal {\n  position: fixed;\n  top: 20% !important;\n  margin: 5%;\n  background-color: #fff;\n  border: 1px solid #ebe6e6;\n  border-radius: 5px;\n  width: 94% !important;\n  -webkit-animation-name: example;\n          animation-name: example;\n  -webkit-animation-duration: 1s;\n          animation-duration: 1s;\n  -webkit-animation-fill-mode: forwards;\n          animation-fill-mode: forwards;\n}\n\n.update-btn {\n  border-radius: 5px !important;\n  text-align: center !important;\n  background: linear-gradient(to left, #000000 0%, #000000 100%);\n  color: #fff;\n  height: 25px;\n  width: 25%;\n  text-align: center;\n  border: 1px solid #fff;\n  font-size: 12px !important;\n  padding: 3px;\n  margin: 15px !important;\n}\n\n.update-category-btn {\n  border-radius: 5px !important;\n  background: linear-gradient(to left, #535252 0%, #0D0D0D 100%);\n  color: #fff;\n  height: 30px;\n  text-align: center;\n  border: 1px solid #fff;\n  font-size: 12px !important;\n}\n\n.delete-acc-btn {\n  border-radius: 5px !important;\n  text-align: center !important;\n  background: linear-gradient(to left, #f34f78 0%, #EB154B 100%);\n  margin: 5px;\n  color: #fff;\n  width: 60% !important;\n}\n\n.buttonCss button.alert-button:nth-child(1) {\n  color: red;\n}\n\n.buttonCss button.alert-button:nth-child(2) {\n  color: green;\n}\n\nion-chip {\n  box-shadow: 0px 5px 17px -7px black;\n  margin-bottom: 10px;\n  color: #fff !important;\n  background: linear-gradient(to right, #555c59 0%, #1d1f1e 100%);\n  background: linear-gradient(to right, #dd5a7b 0%, #EB154B 100%);\n  border-radius: 16px;\n  box-shadow: 1 4px 71px rgba(17, 18, 13, 0.61);\n  backdrop-filter: blur(5px);\n  -webkit-backdrop-filter: blur(5px);\n}\n\n.welcomecard {\n  width: 95%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
